...
- The version of the Polygon Edge.    
  (*Confirm the version of your chro client by running the following command: `chro version --grpc-address GRPC_ADDRESS`*)
...
- Provide us with the peer list of each of your validators by running the following command: `chro peers list --grpc-address GRPC_ADDRESS`.
